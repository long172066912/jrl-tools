...
public class PriorityQueueStatistics extends AbstractHotKeyStatistics {
    ...
    public PriorityQueueStatistics() {

    }

    public PriorityQueueStatistics(int statisticCapacity, int countLeastValue) {
     ...
     */
    private PriorityQueue<HotKeyItem> hotKeyQueue = new PriorityQueue<>(statisticCapacity, (e1, e2) -> e1.getCount().intValue() > e2.getCount().intValue() ? 1 : 0);
