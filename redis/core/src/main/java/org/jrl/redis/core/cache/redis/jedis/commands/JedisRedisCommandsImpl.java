package org.jrl.redis.core.cache.redis.jedis.commands;

import org.jrl.redis.core.cache.redis.jedis.AbstractJedisHandleExecutor;
...
public class JedisRedisCommandsImpl extends AbstractJedisHandleExecutor {
    ...
    public Long decrBy(String key, long decrement, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().decrBy(key, decrement), key);
        } finally {
            if (seconds > 0) {
    ...
    public Long decr(String key, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().decr(key), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long incrBy(String key, long increment, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().incrBy(key, increment), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Double incrByFloat(String key, double increment, int seconds) {
        try {
            return (Double) this.execute(() -> this.getConnectResource().incrByFloat(key, increment), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long incr(String key, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().incr(key), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Boolean hset(String key, String field, String value, int seconds) {
        try {
            return (Boolean) this.execute(() -> this.getConnectResource().hset(key, field, value) > 0 ? true : false, key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Boolean hsetnx(String key, String field, String value, int seconds) {
        try {
            return (Boolean) this.execute(() -> this.getConnectResource().hsetnx(key, field, value) > 0 ? true : false, key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public String hmset(String key, Map<String, String> hash, int seconds) {
        try {
            return (String) this.execute(() -> this.getConnectResource().hmset(key, hash), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Map<String, Object> hmgetToMap(String key, String[] fields) {
        List<String> list = (List<String>) this.execute(() -> {
            return this.getConnectResource().hmget(key, fields);
        }, key);
        if (CollectionUtils.isEmpty(list)) {
    ...
    public Long hincrBy(String key, String field, long value, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().hincrBy(key, field, value), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Double hincrByFloat(String key, String field, double value, int seconds) {
        try {
            return (Double) this.execute(() -> this.getConnectResource().hincrByFloat(key, field, value), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long rpush(String key, String string, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().rpush(key, string), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long lpush(String key, String string, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().lpush(key, string), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long rpush(String key, String[] strings, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().rpush(key, strings), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long lpush(String key, String[] strings, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().lpush(key, strings), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public String lset(String key, long index, String value, int seconds) {
        try {
            return (String) this.execute(() -> this.getConnectResource().lset(key, index, value), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long sadd(String key, String member, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().sadd(key, member), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long sadd(String key, String[] members, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().sadd(key, members), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long zadd(String key, double score, String member, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().zadd(key, score, member), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long zadd(String key, Map<String, Double> scoreMembers, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().zadd(key, scoreMembers), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long zadd(String key, Map<String, Double> scoreMembers, ZAddParams params, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().zadd(key, scoreMembers, params), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Double zincrby(String key, double increment, String member, int seconds) {
        try {
            return (Double) this.execute(() -> this.getConnectResource().zincrby(key, increment, member), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Double zincrby(String key, double increment, String member, ZIncrByParams params, int seconds) {
        try {
            return (Double) this.execute(() -> this.getConnectResource().zincrby(key, increment, member, params), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Set<String> zrevrangeByScore(String key, Range<? extends Number> range, Limit limit) {
        return (Set<String>) this.execute(() -> {
            double max = range.getUpper().getValue().doubleValue();
            double min = range.getLower().getValue().doubleValue();
            if (null == limit) {
                return this.getConnectResource().zrevrangeByScore(key, max, min);
            }
            return this.getConnectResource().zrevrangeByScore(key, max, min, (int) limit.getOffset(), (int) limit.getCount());
        }, key);
    }
    ...
    public Long linsert(String key, Client.LIST_POSITION where, String pivot, String value, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().linsert(key, where, pivot, value), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Boolean setbit(String key, long offset, boolean value, int seconds) {
        try {
            return (Boolean) this.execute(() -> this.getConnectResource().setbit(key, offset, value), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long pfadd(String key, int seconds, String... elements) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().pfadd(key, elements), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long geoadd(String key, double longitude, double latitude, String member, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().geoadd(key, longitude, latitude, member), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
    ...
    public Long geoadd(String key, Map<String, GeoCoordinate> memberCoordinateMap, int seconds) {
        try {
            return (Long) this.execute(() -> this.getConnectResource().geoadd(key, memberCoordinateMap), key);
        } finally {
            if (seconds > 0) {
                CompletableFuture.runAsync(() -> this.expire(key, seconds), threadPoolExecutor);
            }
...
//    }
    ...
    public Object eval(String script, ScriptOutputType outputType, int keyCount, String[] params) {
        return this.eval(script, keyCount, params);
    }
    ...
    public Object evalsha(String sha1, ScriptOutputType outputType, List<String> keys, List<String> args) {
        return this.evalsha(sha1, keys, args);
    }
