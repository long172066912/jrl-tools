 ...
 */
package org.jrl.utils.request.okhttp3.monitor;
 ...
 * doesn't provide URI patterns. We provide {@value JrlOkHttp3MetricsEventListener#URI_PATTERN} header to support
...
@NonNullApi
@NonNullFields
public class JrlOkHttp3MetricsEventListener extends EventListener {
    ...
    protected JrlOkHttp3MetricsEventListener(MeterRegistry registry, String requestsMetricName, Function<Request, String> urlMapper,
    ...
    JrlOkHttp3MetricsEventListener(MeterRegistry registry, String requestsMetricName, Function<Request, String> urlMapper,
                                   Iterable<Tag> extraTags,
                                   Iterable<BiFunction<Request, Response, Tag>> contextSpecificTags,
    ...
    public static class Builder {
        ...
        /**
         * Historically, OkHttp Metrics provided by {@link JrlOkHttp3MetricsEventListener} included a
        ...
        public JrlOkHttp3MetricsEventListener build() {
            return new JrlOkHttp3MetricsEventListener(registry, name, uriMapper, tags, contextSpecificTags, requestTagKeys, includeHostTag);
        }
    }
}
