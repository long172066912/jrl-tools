...
/**
* SunParameterizedTypeImpl
* @author JerryLong
*/
public class JrlSunParameterizedTypeImpl implements ParameterizedType {
    private final Type[] actualTypeArguments;
    private final Class<?> rawType;
    private final Type ownerType;

    private JrlSunParameterizedTypeImpl(Class<?> var1, Type[] var2, Type var3) {
    ...
    public static JrlSunParameterizedTypeImpl make(Class<?> var0, Type[] var1, Type var2) {
        return new JrlSunParameterizedTypeImpl(var0, var1, var2);
    }
    ...
    public String toString() {
        ...
        if (this.ownerType != null) {
            ...
            var1.append("$");
            if (this.ownerType instanceof JrlSunParameterizedTypeImpl) {
                var1.append(this.rawType.getName().replace(((JrlSunParameterizedTypeImpl)this.ownerType).rawType.getName() + "$", ""));
            } else {
